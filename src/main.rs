        ...
        if let Ok(_stro) = arg.parse::<String>() {
            ...
            if let Some(arg) = std::env::args().nth(1) {
                if let Ok(num) = arg.parse::<u64>() {
                    ...
                    println!("Invalid argument! Use a u64 (range 0 through 18446744073709551600)");
                }
             }
         }
     } else {         
